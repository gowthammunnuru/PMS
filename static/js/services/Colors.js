...
angular.module("perform").service("Colors", [
  function() {
    ...
    this.colorScheme = {
      ...
      darkgreen: ['#056F00', '#023A00', '#2A8426', '#82B780', '#046500', ''],
    ...
    palettes = {
      winter: ['#FFCDD2', '#F8BBD0', '#E1BEE7', '#D1C4E9', '#C5CAE9', '#BBDEFB', '#B3E5FC', '#B2EBF2', '#B2DFDB', '#C8E6C9', '#DCEDC8', '#F0F4C3', '#FFF9C4', '#FFECB3', '#FFE0B2', '#FFCCBC', '#D7CCC8', '#F5F5F5', '#CFD8DC'],
      poppyColors: ["#e91e63", "#9c27b0", "#00bcd4", "#8bc34a", "#ffeb3b", "#ffc107", "#ff9800", "#ff5722"]
    };
    pics = ['static/media/peng/mp1.jpg', 'static/media/peng/mp2.jpg', 'static/media/peng/mp3.jpg', 'static/media/peng/mp4.jpg'];
    this.random = function(colors) {
      return colors[Math.floor(Math.random() * colors.length)];
    };
    this.winterPalette = function() {
      return this.random(palettes.winter);
    };
    this.profilePic = function() {
      return this.random(pics);
    };
    this.color = function() {
      return this.random(palettes.poppyColors);
    };
  }
]);
